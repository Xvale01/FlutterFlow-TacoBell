...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? const HomepageWidget() : const CrearTiqueteWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: 'CrearTiquete',
          path: '/crearTiquete',
          builder: (context, params) => const CrearTiqueteWidget(),
        ),
        FFRoute(
          name: 'ConsultarTiqueteAdministrador',
          path: '/consultarTiqueteAdministrador',
          builder: (context, params) => const ConsultarTiqueteAdministradorWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          path: '/cerrarTiqueteTecnico',
          builder: (context, params) => const CerrarTiqueteTecnicoWidget(),
        ),
        FFRoute(
          name: 'InformeTiquetesAdministrador',
          path: '/informeTiquetesAdministrador',
          builder: (context, params) => const InformeTiquetesAdministradorWidget(),
        ),
        FFRoute(
          name: 'InformeTiquetesTecnicos',
          path: '/informeTiquetesTecnicos',
          builder: (context, params) => const InformeTiquetesTecnicosWidget(),
        ),
        FFRoute(
          name: 'HOMEPAGE',
          path: '/homepage',
